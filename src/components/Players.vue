        ...
        <template #item="{ element, index }">
            ...
            >
                ...
                <div class="w-2/12 mr-auto ml-auto mb-4">
                    <div class="ml-6 text-md text-center font-light leading-relaxed mt-4 pb-4">
...
export default {
    ...
    methods: {
        ...
        moved(event) {
            var combinedEvent = {event: event, from: "players"}
            this.$store.dispatch('setMovedEvent',combinedEvent)
        },
        capitalize(value) {
            if (!value) return ''
        ...
        wheelIt (event, index) {
            ...
            if (deltaY > 0) {
                if (this.players[index].initiative > -4) {
                    this.players[index].initiative -= 1
                }
            } else if (deltaY < 0) {
                if (this.players[index].initiative < 35) {
                    this.players[index].initiative += 1
                }
            }
            this.$store.dispatch('commitToStorage')
